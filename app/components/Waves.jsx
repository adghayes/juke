...
export default function Waves({ track, active, barCount,
    upperBarMaxHeight, upperBarMinHeight, lowerBarMaxHeight, lowerBarMinHeight, 
    barWidth, barSpacing, lowerBarAlpha }){
