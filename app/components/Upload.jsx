        ...
        <Dropzone 
            ...
            {({getRootProps, getInputProps}) => (
                <div className="flex flex-col items-center bg-white rounded-xl">
                    ...
                    <section {...getRootProps()} className={`flex flex-col items-center justify-center ` +
                        `focus:outline-none`}>
                            <input {...getInputProps()} />
                            <div className={`flex flex-col items-center justify-center px-20 py-12 md:px-36 md:py-28 lg:px-56 lg:py-44 ` +
                                `m-1.5 border-black border-dashed border-2 rounded-xl md:text-lg lg:text-xl shadow-xl`}>
