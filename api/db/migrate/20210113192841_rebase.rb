...
class Rebase < ActiveRecord::Migration[6.1]
  def change
    ...
    create_table 'likes', force: :cascade do |t|
      ...
      t.index %w[user_id track_id], name: 'index_likes_on_user_id_and_track_id', unique: true
    end
    ...
    create_table 'recents', force: :cascade do |t|
      ...
      t.index %w[user_id track_id], name: 'index_recents_on_user_id_and_track_id', unique: true
    ...
    create_table 'tracks', force: :cascade do |t|
      ...
      t.index %w[owner_id title], name: 'index_tracks_on_owner_id_and_title', unique: true
